...
public class OrderDetail extends Person{
    ...
    public void setDelivered(){this.orderStatus = "Delivered";}
    ...
    public String getCustomerNameString() {
        return this.customerNameString;
    }
    ...
    public void addItemAndQuantity(String menuItem, int itemCount, Menu menu) {
